sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("star/wars/app/app", ".html");
		...
		return Opa5.extend("star.wars.app.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["star/wars/app/localService/mockserver"], function (mockserver) {
